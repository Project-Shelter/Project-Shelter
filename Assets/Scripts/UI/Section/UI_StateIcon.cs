...
public class UI_StateIcon : UI_Section
{
    ...
    public override void Init()
    {
        ...
        SetActor();
        Managers.GetCurrentScene<GameScene>().ActorController.BeforeSwitchActorAction += ResyncActor;
        Managers.GetCurrentScene<GameScene>().ActorController.SwitchActorAction += ReloadIcon;
        SetIcon();
    }
    ...
    {
        Managers.GetCurrentScene<GameScene>().ActorController.CurrentActor.Buff.AddBuffAction += AddIcon;
        Managers.GetCurrentScene<GameScene>().ActorController.CurrentActor.Buff.RemoveBuffAction += RemoveIcon;
    }
    ...
    {
        foreach (var buffTag in Managers.GetCurrentScene<GameScene>().ActorController.CurrentActor.Buff.ActivedBuffs.Keys)
        {
            AddIcon(buffTag);
        }
    }
